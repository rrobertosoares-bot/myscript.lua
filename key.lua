...
local Config = {
    ...
    ServiceId       = 24817, -- Your PlatoBoost Service ID
    PlatoSecret     = "315eb46e-4091-4ce0-9d2a-faae1bd82ac7", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "1901", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/rrobertosoares-bot/myscript.lua/refs/heads/main/script.lua", -- The raw URL of your main script
    
    -- [4] Social Media Settings (Set to true to show, false to hide)
    ShowDiscord     = true,
    DiscordURL      = "https://discord.gg/xDmCVdnwgk",
    ...
    HubName         = "STILXZ HUB", -- The main title shown at the top of the GUI
    HubDescription  = "If it doesnt work contact the owner" -- The text shown below the title
}
